...
This information is fundamental to distinguish the number of regions in the image, so as bigger the \emph{K} is, more cluster are going to be used, therefore more detailed the image will be.  
