...
\subsection{Effect of the threshold}
	...
	\begin{figure}[H]
		  ...
		  \subfloat[T=0,5]{\includegraphics[width=0.3\textwidth]{img/result_348_115-50}}
		  \subfloat[T=0,1]{\includegraphics[width=0.3\textwidth]{img/result_348_115-10}}
		  \subfloat[T=0,01]{\includegraphics[width=0.3\textwidth]{img/result_348_115}}
