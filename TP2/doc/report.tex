...
\section{Histogram}
	...
	\begin{itemize}
  		...
  		\item in such array, find the minimum value at all the spectrum of the color (cdfmin)
	...
	\begin{figure}[H]
	\centering
	\subfloat[Original Image]{\label{fig:original}\includegraphics[width=0.4\textwidth]{../image/view_unequalized}}                
	\subfloat[Stretched Image]{\label{fig:stretched}\includegraphics[width=0.4\textwidth]{../image/view_equalized}}
