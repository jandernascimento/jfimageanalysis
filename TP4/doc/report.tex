...
This result can be achieved simply by adding the euclidian distance for the distance between the pixels. The Equation \ref{equa:diff} should be applied to the intensities red, green and blue and the euclidian distance between the pixel position.
\begin{equation}
